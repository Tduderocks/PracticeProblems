#!python
"""
File:formats.py (2x and 3x)
various specialixed string display formatting utilities.
...
def commas(N):
    """
    format pos integers like N for display with commas
